...
const SummerTips = () => {
    return (
        <div className='mt-15 mb-10'>
            <h1 className='mb-10 text-2xl md:text-4xl lg:text-6xl font-extrabold text-pink-400 text-center mt-6'>Summer <span className='bg-gradient-to-r from-pink-400 to-purple-500 text-transparent bg-clip-text'>Care</span><span className='text-purple-600'> Tips</span></h1>

            <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                <div className="card hover:scale-105 transition duration-300 ease-in-out bg-gradient-to-r from-pink-400 to-purple-500 text-white w-full shadow-sm">
